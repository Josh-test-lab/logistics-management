...
volume_plot <- function(bus, year_index, month.from, month.to) {
  ...
  title(main = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線搭乘次數折線圖'), cex.main = 2, adj = 0)
...
generate_volume_plots <- function(buses, year.from, year.to, month.from, month.to) {
  for (year_index in year.from:year.to) {
    for (bus in buses) {
      ...
      check_path(path)
      img_filename <- paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線搭乘次數折線圖')
...
generate_tpass_volume_plot <- function(buses, year.from, year.to, month.from, month.to) {
  for (year_index in year.from:year.to){
    ...
    # 儲存圖片
      path = paste0("images/", year_index - 1911, "/", bus, "/line chart")
      check_path(path)
      img_filename = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線TPASS搭乘次數折線圖')
      png(filename = paste0(path, "/", img_filename, ".png"), width = 15, height = 5, units = "in", res = 300, family = "kai")
      tpass_volume_plot(bus, year_index, month.from, month.to)
      dev.off()
    }
...
average_daily_tpass_volume_plot <- function(bus, year_index, month.from, month.to) {
  ...
  title(main = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線日均搭乘次數折線圖'), cex.main = 2, adj = 0)
...
generate_average_daily_tpass_volume_plot <- function(buses, year.from, year.to, month.from, month.to) {
  for (year_index in year.from:year.to){
    ...
    # 儲存圖片
      path = paste0("images/", year_index - 1911, "/", bus, "/line chart")
      check_path(path)
      img_filename = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線TPASS日均搭乘次數折線圖')
      png(filename = paste0(path, "/", img_filename, ".png"), width = 15, height = 5, units = "in", res = 300, family = "kai")
      average_daily_tpass_volume_plot(bus, year_index, month.from, month.to)
      dev.off()
    }
...
generate_weekend_and_weekday_volume_plot <- function(buses, year.from, year.to, month.from, month.to) {
  for (year_index in year.from:year.to){
    ...
    # 儲存圖片
      path = paste0("images/", year_index - 1911, "/", bus, "/line chart")
      check_path(path)
      img_filename = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線日均搭乘次數折線圖')
      png(filename = paste0(path, "/", img_filename, ".png"), width = 15, height = 5, units = "in", res = 300, family = "kai")
      weekend_and_weekday_volume_plot(bus, year_index, month.from, month.to)
      dev.off()
    }
...
monthly_gorw_up_plot <- function(bus, year_index, month.from, month.to) {
  ...
  title(main = paste0(year_index - 1 - 1911, '、', year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線運量消長情形同期比較'), cex.main = 2, adj = 0)
...
generate_monthly_gorw_up_plot <- function(buses, year.from, year.to, month.from, month.to) {
  for(bus in buses){
    for (year_index in (year.from + 1):year.to){
      ...
      path = paste0("images/", year_index - 1911, "/", bus, "/line chart")
      check_path(path)
      img_filename = paste0(year_index - 1 - 1911, '、', year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線運量消長情形同期比較')
      png(filename = paste0(path, "/", img_filename, ".png"), width = 15, height = 5, units = "in", res = 300, family = "kai")
      monthly_gorw_up_plot(bus, year_index, month.from, month.to)
      dev.off()
    }
...
weekday_and_weekend_gorw_up_plot <- function(bus, year_index, month.from, month.to) {
  ...
  title(main = paste0(year_index - 1 - 1911, '、', year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線平假日日均次數消長情形'), cex.main = 2, adj = 0)
...
generate_weekday_and_weekend_gorw_up_plot <- function(buses, year.from, year.to, month.from, month.to) {
  for(bus in buses){
    for (year_index in (year.from + 1):year.to){
      ...
      path = paste0("images/", year_index - 1911, "/", bus, "/line chart")
      check_path(path)
      img_filename = paste0(year_index - 1 - 1911, '、', year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線平假日日均次數消長情形')
      png(filename = paste0(path, "/", img_filename, ".png"), width = 15, height = 5, units = "in", res = 300, family = "kai")
      weekday_and_weekend_gorw_up_plot(bus, year_index, month.from, month.to)
      dev.off()
    }
...
tick_type_histgram <- function(bus, year_index, month.from, month.to) {
  ...
  title(main = paste0(year_index - 1911, '年', month.from, '月至', month.to, '月', bus, '路線搭車票種'), cex.main = 2, adj = 0)
