...
```{r}
# 太魯閣客運多年總運量(月)
month_total_volume_plot <- function(buses, year.from, year.to, month.from, month.to, plot_title) {
  ...
  title(main = plot_title, cex.main = 2, adj = 0)
...
generate_month_total_volume_plot <- function(buses, year.from, year.to, month.from, month.to, full_year=FALSE) {
  if (full_year){
    img_filename = paste0(year.from - 1911, '年', month.from, '月', '至', year.to - 1911, '年', month.to, '月太魯閣客運月總運量')
  } else {
    img_filename = paste0(year.from - 1911, '年', '至', year.to - 1911, '年', month.from, '月', '至', month.to, '月太魯閣客運月總運量')
  }
  
  # 繪圖 (在 R中呈現)
  month_total_volume_plot(buses, year.from, year.to, month.from, month.to, img_filename)
...
# 繪圖
generate_month_total_volume_plot(buses, year.from, year.to, 1, 12, full_year=TRUE)  # 全年
