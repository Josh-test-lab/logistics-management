...
```{r}
#png("110-112年乘車人次折線圖.png", family = "kai")

#繪圖
## 字型設定: 標楷體
library(grDevices)
windowsFonts(kai = windowsFont("DFKai-SB"))
par(family = "kai", mar = c(2, 2, 2, 2))
...
# x 軸
axis(side = 1, at = seq(min(year_count$上車年), max(year_count$上車年)), labels = year_count$上車年, cex.axis = 0.5)
